...
<template>
    ...
    >
      <div class="flex flex-wrap w-full">
        <div class="w-full px-[12px]">
          ...
          >
            <div
                class="cols bb-logo-detail flex max-[767px]:justify-between"
            >
              <div
                  class="header-logo flex items-center max-[575px]:justify-center"
              >
                <h1 class="text-[30px] text-[#3d4750] font-bold leading-[1] tracking-[0.03rem]"
                >TECHIFY</h1>
              </div>
              <!-- Header Logo End -->
              <a
  ...
  <Dialog position="top" v-model:visible="visible" modal header="Tài Khoản" :style="{ width: '40rem' }">
    <AccountForm/>
  </Dialog>
</template>