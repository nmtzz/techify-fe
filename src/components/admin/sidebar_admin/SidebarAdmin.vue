  ...
  <div class="flex flex-col h-full">
    <div class="flex items-center justify-between px-6 pt-4 shrink-0">
                        <span class="inline-flex items-center gap-2">
                            ...
                            <span class="font-semibold text-2xl text-primary">TECHIFY</span>
                        </span>
    </div>
    <div>
      <ul class="mt-5 list-none m-0">
        <li>
          <ul class="list-none p-0 m-0 overflow-hidden">
            ...
            <li>
              <router-link v-ripple to="/admin/product"
                           class="flex items-center cursor-pointer p-3 rounded duration-150 transition-colors p-ripple">
    ...
    <div class="mt-auto">
      ...
      <div class="mx-4 mb-4 flex items-center gap-1">
        <Button size="small" label="Account" icon="pi pi-user" class="flex-auto" outlined></Button>
        <Button size="small" label="Logout" icon="pi pi-sign-out" class="flex-auto" severity="danger"
                text></Button>
      </div>
    </div>
  </div>
